...
@endif -->
                    <div class="choooseLocationContainer d-flex align-items-center justify-content-between"
                        ...
                        <div class="choose-location--header  d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                class="ga28-a0 ga28-a1" style="color: rgb(0, 26, 52);">
                            ...
                            <h4 class="choose-location-text font-weight-bold fs-14 mb-0">Hà Nội, Việt Nam</h4>
                        </div>
                        <span>•</span>
                        <div class="chooseLocationDelivery dropdown d-flex align-items-center">
                            <h4 class="chooseLocationDeliveryText fs-14 font-weight-bold m-0 p-0">Nhập địa chỉ giao hàng
                                của bạn</h4>
                ...
                <div class="serviceTop--right d-flex">
                    <ul class="serviceTop--menu d-flex align-items-center mb-0">
                        <li><a href="#">Thú Cưng cho doanh nghiệp</a></li>
                        <li><a href="#">Ứng dụng di động</a></li>
                        <li><a href="#">Bán trên thú cưng</a></li>
                        <li><a href="#">Kiếm tiền với thú cưng</a></li>
