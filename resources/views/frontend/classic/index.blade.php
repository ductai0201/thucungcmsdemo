...
@section('content')
    ...
    <div class="home-banner-area mb-3" style="">
        <div class="container">
            <div class="row p-0!important">
                <!-- Sliders -->
                <div class="home-slider col-8 ">
                    @if (get_setting('home_slider_images', null, $lang) != null)
                        <div class="aiz-carousel dots-inside-bottom" data-autoplay="true" data-infinite="true">
                            ...
                            <!-- @foreach ($sliders as $key => $slider)
                                <div class="carousel-box">
                                    <a href="{{ isset(json_decode($home_slider_links, true)[$key]) ? json_decode($home_slider_links, true)[$key] : '' }}">
                                        ...
                                        <img class="bannerSliderPrimary" src="{{ static_asset('assets/img/banner/bannerPR.png') }}" alt="">
                                        </a>
                                </div>
                            @endforeach -->
                            <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" navigation="true"
                                ...
                                @foreach ($sliders as $key => $slider)
                                    <swiper-slide>
                                        <!-- <img class="d-block mw-100 img-fit overflow-hidden w-934px h-280px  overflow-hidden rounded-lg"
                                            src="{{ $slider ? my_asset($slider->file_name) : static_asset('assets/img/placeholder.jpg') }}"
                                            alt="{{ env('APP_NAME') }} promo"
                                            onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';"
                                            alt=""> -->
                ...
                <div class="payMoneyAdsProduct col-4 ">
                        <div class="productOneDay d-flex align-items-center justify-content-between">
                            <h2 class="font-weight-bold ">Sản phẩm trong ngày</h2> 
                            <span class="font-weight-bold inline-block">12:50:03</span>
                        </div>
                </div>
